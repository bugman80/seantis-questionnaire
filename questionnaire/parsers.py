...
def __make_parser():
    ...
    return Dict(ZeroOrMore(Group(key + Optional(Suppress("=") + value,
                                                default=True))))
...
class Checker(object):
    """Simple wrapper to call a specific function, passing in args and
    kwargs each time
    """
...
"""
    ...
    def __init__(self, func, *args, **kwargs):
        ...
        self.boolExpr = operatorPrecedence(
            boolOperand,
            [
